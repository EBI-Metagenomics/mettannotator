...
# Modified on 1st May 2025
# This version of the script works with proMGE v3.11 @42edece and MAP v >= 2.0
...
def main():
    parser = argparse.ArgumentParser(
        description="This script conciliates descriotion and merge the coordinates of predicted MGEs using the Mobilome Annotation Pipeline version >= 2.0 and proMGE v3.11 @42edece. Please provide the gff files generated for the same genome using both methods."
    )
    parser.add_argument(
        "--mobannot",
        type=str,
        help="Mobilome Annotation Pipeline predictions (no genes) (gff)",
        required=True,
    )
    parser.add_argument(
        "--proMGE",
