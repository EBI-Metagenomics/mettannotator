...
class TestAdjustPseudofinderOutput(unittest.TestCase):
    ...
    def test_main(self):
        ...
        main(self.pseudofinder_output, self.prokka_standard, self.prokka_compliant, test_output)
        self.assertTrue(filecmp.cmp(test_output, self.expected_output, shallow=False),
